...
describe('Webpack/utils', () => {
  test('should return normalized asset name', () => {
    ...
    expect(getAssetName('main.d249062.js')).toBe('main.js');
    ...
    expect(getAssetName('login-chunk.d249062.js')).toBe('login-chunk.js');
    expect(getAssetName('login-abcde.d249062.js')).toBe('login-abcde.js');
    expect(getAssetName('login-abcde-chunk.js')).toBe('login-abcde-chunk.js');
    expect(getAssetName('web-app/login-chunk.d249062.js')).toBe('web-app/login-chunk.js');

    expect(getAssetName('static/d249062/pages/app.js')).toBe('static/pages/app.js');
    expect(getAssetName('static/chunks/d249062c08abb6b31a03.js')).toBe(
      'static/chunks/d249062c08abb6b31a03.js',
    );
    expect(getAssetName('static/css/main.d249062.chunk.css')).toBe('static/css/main.chunk.css');
  });
});
